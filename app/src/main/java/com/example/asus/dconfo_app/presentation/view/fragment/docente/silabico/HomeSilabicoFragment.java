...
public class HomeSilabicoFragment extends Fragment
    ...
    int idgrupo;
    String namedocente;
    private RecyclerView rv_tipoSilabico;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_home_silabico, container, false);
        ...
        rv_tipoSilabico = (RecyclerView) view.findViewById(R.id.rv_silabicos);
        rv_tipoSilabico.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        rv_tipoSilabico.setHasFixedSize(true);
...
//idgrupo,namegrupo,curso_idcurso,curso_Instituto_idInstituto
                ...
                tipoEjerciciosActividadDocenteAdapter.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        idejercicio = listaEjercicios.get(rv_tipoSilabico.
                                getChildAdapterPosition(v)).getIdEjercicioG2();

                        Toast.makeText(getContext(), "idejercicio: " + idejercicio, Toast.LENGTH_LONG).show();

                        idactividad = listaEjercicios.get(rv_tipoSilabico.
                                getChildAdapterPosition(v)).getIdActividad();

                        idtipo = listaEjercicios.get(rv_tipoSilabico.
                                getChildAdapterPosition(v)).getIdTipo();

                        oracion = listaEjercicios.get(rv_tipoSilabico.
                                getChildAdapterPosition(v)).getOracion();

                        cantLexemas = listaEjercicios.get(rv_tipoSilabico.
                                getChildAdapterPosition(v)).getCantidadLexemas();

                        letrainicial = listaEjercicios.get(rv_tipoSilabico.
                        ...
                        if (idtipo == 5) {//************listo
                            ...
                            getFragmentManager().beginTransaction().replace(R.id.container_silabico_ejercicios, tipo1silabicoEstudianteFragment)
                ...
                rv_tipoSilabico.setAdapter(tipoEjerciciosActividadDocenteAdapter);
            ...
            try {
                ...
                if (idtipo == 6) {
                    Toast.makeText(getContext(), "idtipo*******: " + idtipo, Toast.LENGTH_LONG).show();
                    getFragmentManager().beginTransaction().replace(R.id.container_silabico_ejercicios, tipo2silabicoEstudianteFragment)
                            .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE)
                            .addToBackStack(null).commit();
                }
